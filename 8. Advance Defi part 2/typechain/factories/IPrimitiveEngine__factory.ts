...
import type {
  IPrimitiveEngine,
  IPrimitiveEngineInterface,
} from "../IPrimitiveEngine";
...
export class IPrimitiveEngine__factory {
  ...
  static createInterface(): IPrimitiveEngineInterface {
    return new utils.Interface(_abi) as IPrimitiveEngineInterface;
  }
  static connect(
    address: string,
