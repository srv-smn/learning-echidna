...
interface EchidnaMockEngineInterface extends ethers.utils.Interface {
  functions: {
    ...
    "setReserves(bytes32,uint256,uint256)": FunctionFragment;
    ...
    "updateReserves(bytes32,uint256)": FunctionFragment;
...
export class EchidnaMockEngine extends BaseContract {
  ...
  interface: EchidnaMockEngineInterface;
