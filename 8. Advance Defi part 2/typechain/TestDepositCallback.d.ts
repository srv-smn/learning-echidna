...
interface TestDepositCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class TestDepositCallback extends BaseContract {
  ...
  interface: TestDepositCallbackInterface;
