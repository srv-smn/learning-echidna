...
interface TestAllocateCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class TestAllocateCallback extends BaseContract {
  ...
  interface: TestAllocateCallbackInterface;
