...
interface TestCreateCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class TestCreateCallback extends BaseContract {
  ...
  interface: TestCreateCallbackInterface;
