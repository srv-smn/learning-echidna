...
interface TestSwapCallbackInterface extends ethers.utils.Interface {
  functions: {
...
export class TestSwapCallback extends BaseContract {
  ...
  interface: TestSwapCallbackInterface;
